<x-layout>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create a new post</h1>
        </div>
        <form method="POST" action="/admin/new" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group col-5">
                ...
                <textarea class="form-control form-control-lg" name="content" id="exampleFormControlTextarea1" rows="3"></textarea>
              </div>
              @error('content')
              <small class="form-text text-danger">{{ $message }}</small>
              @enderror
